...
tidy(mod2) %>% 
  kable()
```
\noindent NBP: When all else is held constant, on average counties that have been regulated under the NOx Budget program (nbp = 1) will have a change in NOx emmissions from all power plants in the counties between 2000-2008 of -7.14 tons.

D: When all else is held constant, on average counties that have an average PctBlack above the median (19.31)(D=1) will have a change in NOx emmissions from all power plants in the counties between 2000-2008 of -2.59 tons.
